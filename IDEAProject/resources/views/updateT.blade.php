    ...
    <div class="container-fluid" style="background-color: #003366;">
        ...
        <div class="row" style="background-color: #1b1a19;">
            ...
            <div class="col col-md-4 mb-5 mt-5" style="border-radius: 10px; background-color: #F5F5DC;">
                <h2 class="text-center mt-4">Edit Product Type</h2>

                <form method = "POST" action = "{{ url('updateT/'.$type->id) }}" enctype="multipart/form-data" style="margin-top: 25px; margin-bottom: 30px; margin-left: 15px; margin-right:15px;" >
                    
                    {{ csrf_field() }}

                    <div class="form-group">
                        <label for="name" class="font-weight-bold">Name</label>
                        <input type="text" name="Name" class="form-control" id="name" placeholder="Enter name" value="{{ $type->type }}">
                    </div>
                    ...
                    <div class="text-center">
                        <button type="submit" value="Update" class="btn btn-primary text-center">Submit</button>
                    </div>
