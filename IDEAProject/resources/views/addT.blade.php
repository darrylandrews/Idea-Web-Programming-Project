    ...
    <div class="container-fluid" style="background-color: #003366;">
        ...
        <div class="row" style="background-color: #1b1a19;">
            ...
            <div class="col col-md-4 mb-5 mt-5" style="border-radius: 10px; background-color: #F5F5DC;">
                <h2 class="text-center mt-4">Add New Product Type</h2>

                <form method = "POST" action = "{{ url('addT') }}" enctype="multipart/form-data" style="margin-top: 25px; margin-bottom: 30px; margin-left: 15px; margin-right:15px;" >
